                                                    ...
                                                    <div class="row margin-bottom-40">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                <table id="tbl_ma" class="table table-bordered table-striped table-condensed table-hover">
                                                                    <thead>
                                                                        <tr>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                <table id="tbl_pm" class="table table-bordered table-striped table-condensed table-hover">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="text-center"> Consultor </th>
                                                                            <th class="text-center"> Em Curso </th>
