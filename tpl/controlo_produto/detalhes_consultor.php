...
if (!empty($url_cst_id)) {
    ...
    if (empty($id_consultor)) {
        ...
        $sql_cst = "
            ...
            INNER JOIN user_loja ON user_loja.user = consultor.id
                                            ...
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        ...
                                                        <span class="caption-subject font-blue bold uppercase">Detalhes Consultor</span>
                                                    </div>
                                                </div>
