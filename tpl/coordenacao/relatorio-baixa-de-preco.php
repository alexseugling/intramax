                    ...
                    <div class="page-content">
                        <div class="container">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <a href="<?php setHome(); ?>/coordenacao/relatorios">Relatórios</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                                    <span>Relatório de Baixa de Preço</span>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-line-chart font-blue"></i> <i class="fa fa-arrow-down font-blue"></i>
                                                        <span class="caption-subject font-blue bold uppercase"> Relatório de Baixa de Preço</span>
                                                    </div>
                                                </div>
