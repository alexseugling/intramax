                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="alert alert-danger text-center">
                                                                                            <strong>ATENÇÃO! NÃO PROSSIGA</strong> se o Gestor do Consultor estiver Incorreto ou em Branco. Se For Este o Caso, <strong>Informe o Marketing</strong>.
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input name="num_contrato" minlength="6" maxlength="13" class="form-control form-control-inline retira <?= $filtro_nc; ?>" type="text" value="<?= $nc; ?>" <?= $lock; ?> placeholder="Digite o Número de Contrato" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input name="dur_contrato" class="form-control form-control-inline numeros" type="text" value="180" />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input name="fracao" class="form-control form-control-inline" type="text" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select name="tipo_comissao" class="form-control select2 dropd tip-com">
                                                                                                <option value=""></option>
                                                                                                <option value="1">Percentual (Inteiro)</option>
                                                                                                <option value="2">Valor Fixo</option>
                                                                                                <option value="3">Percentual (Fracionado)</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input name="valor_comissao" class="form-control form-control-inline val-com" type="text" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <p class="form-control-static" data-display="fracao"> </p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3">
