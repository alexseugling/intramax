...
$page = 'atualizar-livro-de-registos';
?>
                    ...
                    <div class="page-content">
                        <div class="container">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <span>Atualizar Livro de Registos</span>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-book font-blue"></i> <i class="fa fa-refresh font-blue"></i>
                                                        <span class="caption-subject font-blue bold uppercase"> Atualizar Livro de Registos</span>
                                                    </div>
                                                </div>
