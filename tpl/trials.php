...
//    $sql_gc = "SELECT gst.gestor id_gst, col.nome nome_gst, colaboradores.id id_cst, colaboradores.nome nome_cst
//    FROM gestor gst
                                                                        ...
                                                                        <div class="tab-content">
                                                                            ...
                                                                            <div class="tab-pane active" id="tab1">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            <label class="control-label">Data de Inserção no Ilist
                                                                                                <span class="required"> * </span>
                                                                                            </label>
                                                                                            <div>
                                                                                                <input name="insercao_ilist" class="form-control form-control-inline date-picker" type="text" value="<?= date("d/m/Y"); ?>" readonly />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3">
                                                                            ...
                                                                            <div class="tab-pane" id="tab2">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                            <label class="control-label">Nº do Contrato (Sem a Loja ou Ano)</label>
                                                                                            <div>
                                                                                                <input name="num_contrato" class="form-control form-control-inline numeros" type="text" />
                                                                                                <span class="help-block"> Inserir APENAS o Número </span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input name="data_cmi" class="form-control form-control-inline date-picker" type="text" value="" readonly />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select name="regime" class="form-control select2 dropd">
                                                                                                ...
                                                                                                <option value="2">Exclusivo de Rede</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input name="nif_prop" class="form-control form-control-inline phone" type="text" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <input name="telefone_prop" class="form-control form-control-inline phone" type="text" />
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-3">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div>
                                                                                                <p class="form-control-static" data-display="insercao_ilist"> </p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-3">
