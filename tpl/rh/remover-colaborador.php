                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet light">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-user-times font-blue"></i>
                                                        <span class="caption-subject font-blue bold uppercase"> Remover Colaborador</span>
                                                    </div>
                                                </div>
                                                <div class="portlet-body form">                                                    
                                                    <form class="form-horizontal" action="<?php setHome(); ?>/tpl/actions/#.php" id="submit_form" method="POST">
