...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $cod_loja = $_SESSION['user_store_code'];
    $produto_espelho = "";
...
//    echo "<br><hr><br>";
    ...
    if ($tipo_ang == 1) {
        ...
        if ($tipo_neg == 1) {
            // venda
            // echo "É Venda <br>";
            if ($cod_loja == 2 or $cod_loja == 3 or $cod_loja == 4 or $cod_loja == 5 or $cod_loja == 7 or $cod_loja == 9 or $cod_loja == 10 or $cod_loja == 11 or $cod_loja == 13 or $cod_loja == 15 or $cod_loja == 16 or $cod_loja == 17 or $cod_loja == 19) {
                if ($valor_antigo_imv > 100000.00) {
                    // maior que 100 mil 
                    // echo "É maior que 100 mil euros <br>";
                ...
                if ($valor_antigo_imv >= 50000.00 && $valor_antigo_imv <= 100000.00) {
                    // entre 50 mil a 100 mil
                    // echo "Entre 50 mil a 100 mil euros <br>";
                    if ($novo_valor_imv <= $valor_antigo_imv - 5000.00) {
                        // é produto e vai para o espelho
                        // echo "Vai para o espelho porque o novo valor tem um abatimento MAIOR ou IGUAL que 5 mil euros <br>";
                        $produto_espelho = 1;
                    } else {
                        // não é produto e não vai para o espelho
                ...
                if ($valor_antigo_imv < 50000.00) {
                    // menor que 50 mil
                    // echo "É menor que 50 mil euros <br>";
                    if ($novo_valor_imv <= $valor_antigo_imv - 3500.00) {
                        // é produto e vai para o espelho
                        // echo "Vai para o espelho porque o novo valor tem um abatimento MAIOR ou IGUAL que 3.500 euros <br>";

                        $produto_espelho = 1;
                    } else {
                        // não é produto e não vai para o espelho
                        // echo "Não vai para o espelho porque o novo valor tem um abatimento MENOR que 3.500 euros <br>";
                        $produto_espelho = 0;
                    }
                }
            } else {
