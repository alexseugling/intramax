...
$sql = "
    ...
    WHERE id_angariacao.an_{$limit} = 0 AND livro_registo.estado_imovel = 1 AND angariacoes.data_insercao_ilist < DATE_ADD(NOW(), INTERVAL -{$limit} DAY) AND angariacoes.data_insercao_ilist > DATE_ADD(NOW(), INTERVAL -31 DAY)
    ";
?>
                    ...
                    <div class="page-content">
                        <div class="container">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <span>Angariações com 15 Dias</span>
                                </li>
                            </ul>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet box green-meadow">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-calendar-check-o"></i> Angariações com 15 Dias
                                                </div>
                                            </div>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <button class="btn btn-xs green-meadow dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Ações
                                                                                <i class="fa fa-angle-down"></i>
                                                                            </button>
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                <li>
                                                                                    <a href="<?php setHome(); ?>/qualidade/questionario-15-dias/<?= $id_imovel; ?>">
                                                                                        <i class="fa fa-question-circle"></i> Questionário </a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="<?php setHome(); ?>/qualidade/observacoes/<?= $id_imovel; ?>/15">
