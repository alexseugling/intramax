                    ...
                    <div class="page-content">
                        <div class="container">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <a href="<?php setHome(); ?>/qualidade/angariacoes-120-dias">Angariações 120 Dias</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <li>
                                    <span>Questionário de 120 Dias</span>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-md-12">
                                            <div class="portlet box purple">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        <i class="fa fa-question-circle"></i> Questionário de 120 Dias
                                                    </div>
                                                </div>
                                                <div class="portlet-body"> 
                                                    ...
                                                    $inquerito_anterior = $btn_15 = $btn_60 = "hidden";
                                                    $sql_quest15 = "
                                                    ...
                                                    <div class="row <?= $encontrado; ?>">
                                                        <div class="col-md-12">
                                                            ...
                                                            ?>
                                                            <form role="form" class="margin-bottom-20" action="<?php setHome(); ?>/tpl/actions/questionario_120.php" method="post">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <p class="bold font-red-intense">
                                                                                Uma vez que o seu imóvel está a ser promovido há mais de 120 dias 
                                                                                sem os resultados desejados, foi-lhe apresentado pelo consultor:
                                                                            </p>
                                                                        </div>                                                                        
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="mt-checkbox-inline">
                                                                                <label class="mt-checkbox mt-checkbox-outline">
                                                                                    <input type="checkbox" name="estrategias[]" value="Baixa de Preço"> Baixa de Preço
                                                                                    <span></span>
                                                                                </label>
                                                                                <label class="mt-checkbox mt-checkbox-outline">
                                                                                    <input type="checkbox" name="estrategias[]" value="Publicidade"> Publicidade
                                                                                    <span></span>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <button name="filtro" type="submit" class="btn purple btn-block bold uppercase">Finalizar Questionário</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
