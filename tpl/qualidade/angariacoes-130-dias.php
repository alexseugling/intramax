...
$page = 'angariacoes-130-dias';

include_once("tpl/actions/conexao.php");
$sql = "
    SELECT angariacoes.id id_angariacao, angariacoes.data_insercao_ilist entrada_ilist, id_angariacao.loja id_loja, info_loja.nome nome_loja, id_angariacao.id_imovel id_imovel, id_angariacao.consultor id_consultor, colaboradores.nome nome_consultor, livro_registo.nome_proprietario nome_cliente, livro_registo.telefone_proprietario telefone_cliente, livro_registo.estado_imovel estado_imovel, qlt_q120.data data_q120
    FROM angariacoes
    ...
    WHERE id_angariacao.an_130 = 2 AND livro_registo.estado_imovel = 1 AND NOW() >= DATE_ADD(qlt_q120.data, INTERVAL +10 DAY)
    ";
?>
                    ...
                    <div class="page-content">
                        <div class="container">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <span>Angariações com 130 Dias</span>
                                </li>
                            </ul>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="portlet box dark">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-calendar-check-o"></i> Angariações com 130 Dias
                                                </div>
                                            </div>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <button class="btn btn-xs dark dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Ações
                                                                                <i class="fa fa-angle-down"></i>
                                                                            </button>
                                                                            <ul class="dropdown-menu" role="menu">
                                                                                <li>
                                                                                    <a href="<?php setHome(); ?>/qualidade/questionario-130-dias/<?= $id_imovel; ?>">
                                                                                        <i class="fa fa-question-circle"></i> Questionário </a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="<?php setHome(); ?>/qualidade/observacoes/<?= $id_imovel; ?>/130">
